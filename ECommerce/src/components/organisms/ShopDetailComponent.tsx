...
import { IUrunModel } from '../../models/IUrunModel';

interface IShopDetailComponentProps{
    id: string | undefined
}
function ShopDetailComponent(props: IShopDetailComponentProps) {
  const [urun,setUrun] = useState<IUrunModel>();
  useEffect(()=>{
    fetch('http://localhost:9090/dev/v1/urun/get-urun/'+props.id)
    .then(res=>res.json())
    .then(response=>{
    ...
    <div className="container-fluid py-5">
        <div className="row px-xl-5">
                ...
                <div id="product-carousel" className="carousel slide" data-ride="carousel">
                    <div className="carousel-inner border">
                        <div className="carousel-item active">
                            <img className="w-100 h-100" src={urun?.resim} alt="Image"/>
                        </div>
            ...
            <div className="col-lg-7 pb-5">
                <h3 className="font-weight-semi-bold">{urun?.ad}</h3>
                <div className="d-flex mb-3">
                    ...
                    <small className="pt-1">({urun?.stok} Stock)</small>
                </div>
                <h3 className="font-weight-semi-bold mb-4">{(urun?.fiyat)}</h3>
